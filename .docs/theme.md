...
- **Cloudy Day**: Orange gradient (`#fbbf24` to `#f59e0b`) with white text and warm shadow
- **Ocean**: Cyan gradient (`#06b6d4` to `#0891b2`) with white text and aqua glow
- **Forest**: Green gradient (`#22c55e` to `#16a34a`) with white text and nature shadow
